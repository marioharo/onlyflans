...
SECRET_KEY = 'django-insecure-972%ktu)pjhp#_y3@fr!eww1k0p(ej@)qt!qenel-+s&ai0jgs'
...
INSTALLED_APPS = [
    ...
    'django.contrib.sessions', # un framework de sesion
    ...
    'web', # la primera app del proyecto (core)
]
...
LOGIN_REDIRECT_URL = '../../bienvenido/' # al iniciar sesión muestra este endpoint
